...
var audio = new Audio('bpm/150bpm.mp3'); // 請替換為您的音樂檔案路徑
...
function showCategory(category) {
    ...
    if (category === '何木火') {
        ...
        selectedImages = ['畢卡索/Houses on the hill.jpg', 
            '畢卡索/Cafe Royan.jpg', 
            '畢卡索/格爾尼卡.jpg', 
        ...
        selectedImages = ['弗里德里希/Two Men Contemplating the Moon.jpg', 
...
window.onclick = function(event) {
    if (!event.target.matches('.item')) {
        var dropdowns = document.getElementsByClassName("bpm-content", "guidebpm-content");
